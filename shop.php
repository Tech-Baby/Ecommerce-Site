          ...
          <hr>
            ...
            <p>Category</p>
               <div class="form-check">
                <input class="form-check-input" value="snickers" type="radio" name="category" id="category_one" <?php if(isset($category) && $category=='snickers'){echo 'checked';}?> >
              ...
              <div class="form-check">
                <input class="form-check-input" value="dresses" type="radio" name="category" id="category_two" <?php if(isset($category) && $category=='dresses'){echo 'checked';}?>>
               ...
               <div class="form-check">
                ...
                <label class="form-check-label" for="flexRadioDefault2">
                  Watches
                    ...
                    <div class="form-check">
                      <input class="form-check-input" value="bag" type="radio" name="category" id="category_two" <?php if(isset($category) && $category=='bag'){echo 'checked';}?>>
                         <label class="form-check-label" for="flexRadioDefault2">
                          Bags
                         </label>
                          </div>
